...
@section('editprofile')
    ...
    <form action="{{ action('EditProfileController@store') }}" method="post">
  ...
  'ZW' => 'Zimbabwe',
        ...
        <div class="form-group">
            ...
            {!! Form::number('height', $user->height, ['class' => 'form-control']) !!}
        </div>
        ...
        <div class="form-group">
            ...
            {!! Form::number('contact', $user->contact, ['class' => 'form-control']) !!}
        </div>
        ...
        {{--LEVEL--}}
        <div class="form-group">
            {!! Form::label('level', 'Experience:', ['class' => 'control-label']) !!}
            {!! Form::select('level',
            [
                'rookie' => 'rookie',
